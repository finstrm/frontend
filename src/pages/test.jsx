            ...
            <div className="min-h-full">
                <Transition.Root show={sidebarOpen} as={Fragment}>
                    <Dialog as="div" className="relative z-40 lg:hidden" onClose={setSidebarOpen}>
                        ...
                        <div className="fixed inset-0 z-40 flex">
                            ...
                            >
                                <Dialog.Panel
                                    className="relative flex w-full max-w-xs flex-1 flex-col bg-blue-700 pb-4 pt-5">
                                    <Transition.Child
                                        as={Fragment}
                                    ...
                                    >
                                        <div className="space-y-1 px-2">
                                            {navigation.map((item) => (
                                                ...
                                                >
                                                    <item.icon className="mr-4 h-6 w-6 flex-shrink-0 text-blue-200"
                                                               aria-hidden="true"/>
                                                    {item.name}
                                                </a>
                                            ))}
                                        ...
                                        <div className="mt-6 pt-6">
                                            <div className="space-y-1 px-2">
                                                {secondaryNavigation.map((item) => (
                                                    ...
                                                    >
                                                        <item.icon className="mr-4 h-6 w-6 text-blue-200"
                                                                   aria-hidden="true"/>
                                                        {item.name}
                                                    </a>
                                                ))}
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
                    ...
                    <div className="flex flex-grow flex-col overflow-y-auto bg-blue-700 pb-4 pt-5">
                        ...
                        <nav className="mt-5 flex flex-1 flex-col divide-y divide-blue-800 overflow-y-auto"
                             aria-label="Sidebar">
                            <div className="space-y-1 px-2">
                                {navigation.map((item) => (
                                    <a
